...
Sign in or Sign up
1,931 30,798 11,651 ansible/ansible
 Code  Issues 3,642  Pull requests 1,524  Projects 22  Insights
ansible/lib/ansible/modules/cloud/vmware/vmware_guest.py
c021fd8  7 days ago
@Akasurde Akasurde VMware: Allow user to select disk_mode (#38951)
@Akasurde @dagwieers @jctanner @aperigault @nerzhul @abadger @dav1x @Shaps @sivel @mattclay @gundalow @cigamit @doubleplush @balonik @yasensim @strattner @garbled1 @rollerwhrtn @rndmh3ro @reversecipher @pdellaert @MikeKlebolt @tchernomax @quorten @frntn @gptech

2293 lines (1998 sloc)  110 KB
#!/usr/bin/python
# -*- coding: utf-8 -*-
#
...
def main():
    ...
    argument_spec.update(
        ...
        nic_state=dict(type="str", default=False),
    )
